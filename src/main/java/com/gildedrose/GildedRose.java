...
class GildedRose {
    ...
    public void updateQuality() {
        for (int i = 0; i < items.length; i++) {
            if (!items[i].name.equals(ITEM_NAME_AGED_BRIE)
                    && !items[i].name.equals(ITEM_NAME_BACKSTAGE_PASSES)) {
                if (items[i].quality > 0) {
                    if (!items[i].name.equals(ITEM_NAME_SULFURAS)) {
                ...
                if (items[i].quality < 50) {
                    ...
                    if (items[i].name.equals(ITEM_NAME_BACKSTAGE_PASSES)) {
